...
const verifyServiceSid = process.env.TWILIO_VERIFY_SERVICE_SID || '<set in .env>';
...
console.log('   - Send OTP: https://us-central1-gametime-app-4e0e3.cloudfunctions.net/sendOtp');
console.log('   - Verify OTP: https://us-central1-gametime-app-4e0e3.cloudfunctions.net/verifyOtp');
